...
public class RecentContactsFragment extends TFragment {
    ...
    public TextView yanzhengxiaoxi;
    // data
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        View rootView=inflater.inflate(R.layout.nim_recent_contacts, container, false);
        recyclerView = rootView.findViewById(R.id.recycler_view);
        emptyBg = rootView.findViewById(R.id.emptyBg);
        emptyHint = rootView.findViewById(R.id.message_list_empty_hint);
        yanzhengxiaoxi = rootView.findViewById(R.id.yanzhengxiaoxi);
        return rootView;
    }
